...
var soundMan = require('soundmanager2');

// hate the game
var app = angular.module('ngPlayerHater', []);
module.exports = app.name;

app.factory('globalSoundManager', function ($window) {
  return soundMan.soundManager;
});
...
app.provider('soundManager', soundManager2Provider);
...
app.factory('smSound', SoundFactory);
