module.exports = function ( grunt ) {
  ...
  var taskConfig = {
    ...
    /**
     * `stylus` handles our styl compilation and uglification automatically.
  ...
  grunt.registerTask( 'build', [
    'clean', 'jshint', 'coffeelint', 'coffee', 'jade', 'html2js', 'stylus:build',
